...
const DOCS = {
  ...
  deps: D("doc_025","Schedule","GreenLedger engine","Fleet depreciation · 3 trucks · SL 60 mo · June 1,450.00 · schedule replayable"),
          ...
          <div>
            ...
            <Card title="This month's advisory notes" style={{ marginTop:14 }}>
              {[
                ...
                ["Sales tax cadence", "The Texas Comptroller webfile pattern suggests monthly remittance. Once confirmed by the CPA of record, GreenLedger will draft each filing for A. Whitfield's signature — filings never leave without a licensed human."],
              ].map(([t, b], i) => (
              ...
              <div style={{ marginTop:10, fontSize:11.5, fontFamily:T.mono, color:T.brass }}>
                ADVISORY — generated by greenledger-cfo-1, reviewed by M. Reyes before delivery. No action taken automatically.
              </div>
            </Card>
          </div>
        )}
            ...
            {(() => {
              ...
              const steps = [
                ...
                e.ai ? ["2 · AI proposal (never posts by itself)", [
                  ["“" + e.ai.why + "”", true],
                  [`confidence ${e.ai.conf.toFixed(2)} · pattern: ${e.ai.pat} · model greenledger-cat-1`, false],
